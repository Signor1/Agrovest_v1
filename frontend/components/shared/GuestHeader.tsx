                ...
                <MaxWrapper className="h-full w-full flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <div className="md:hidden">
                            <button onClick={() => setShowMobileNav(!showMobileNav)} className="bg-white text-darkgreen rounded-[10px] p-1.5" >
                                ...
                                <ul className="flex flex-col lg:hidden mt-10 items-start gap-6">
                                    {
                                        navLinks.map((link, index) => (
                                            ...
                                            before:rounded-full before:opacity-0 before:transition-all before:duration-[0.3s] before:ease-[ease-out] before:delay-[0s]  before:top-1 before:-left-3 before:bg-lightgreen group-hover:text-lightgreen  group-hover:before:opacity-100 ${pathname === link.href && "text-lightgreen before:opacity-100"}`}
                                                    href={link.href}
                                                >
                                                    {link.name}
                                                </Link>
